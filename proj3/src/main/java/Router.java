...
public class Router {
    ...
    public static List<Long> shortestPath(GraphDB g, double stlon, double stlat,
        ...
        for(Long id:g.vertices()){
            if(id.equals(startNode)){  //use Long not long,need a wrapper
            ...
            for(Long to : g.adjacent(from)){
                ...
                if (disTo.get(to) > disTo.get(from)+g.distance(to,from)){
                    ...
                    if (fringe.contains(to)){
                        fringe.remove(to);
                        fringe.add(to);   //will this work?
                    }

                    if(to.equals(endNode)){
                        flag = true;
                    }
                }
            }
...
//    private static void relax(long from,long to,HashMap disTo) {
//        if(disTo.get(to) > disTo.get(from)+){}
//    }
